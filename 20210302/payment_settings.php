...
$mf_properties = mf_get_form_properties($dbh, $form_id, array(
    'form_active'
));
...
{
    if ($price_field_array[$element_id]['element_type'] == 'money')
    { //if this is 'price' field
						...
						<li>
							<div id="ps_box_merchant_settings" class="ps_box_main gradient_blue">
								...
								<div class="ps_box_content">
									<span>	
										<input id="ps_enable_merchant" class="checkbox" value="" type="checkbox" style="margin-left: 0px" <?php if (!empty($payment_properties->enable_merchant))
{
    echo 'checked="checked"';
									...
									<select class="select" id="ps_select_merchant" style="width: 60%" autocomplete="off">
										<option <?php if ($payment_properties->merchant_type == 'paypal_standard')
{
										...
										<option <?php if ($payment_properties->merchant_type == 'stripe')
{
    echo 'selected="selected"';
										...
										<option <?php if ($payment_properties->merchant_type == 'authorizenet')
{
    echo 'selected="selected"';
} ?> value="authorizenet">Authorize.net</option>
										<option <?php if ($payment_properties->merchant_type == 'braintree')
{
    echo 'selected="selected"';
} ?> value="braintree">Braintree</option>
										<option <?php if ($payment_properties->merchant_type == 'check')
{
    echo 'selected="selected"';
} ?> value="check">Check / Cash</option>
										<option <?php if ($payment_properties->merchant_type == 'paypal_rest')
{
    echo 'selected="selected"';
									...
									<div id="ps_paypal_options" class="merchant_options" <?php if ($payment_properties->merchant_type != 'paypal_standard')
{
    echo 'style="display: none"';
										...
										<select id="ps_paypal_language" name="ps_paypal_language" class="select large" style="width: 95%">
											<option value="US" <?php if ($payment_properties->paypal_language == 'US')
{
    echo 'selected="selected"';
} ?>>English (American)</option>
											<option value="GB" <?php if ($payment_properties->paypal_language == 'GB')
{
    echo 'selected="selected"';
} ?>>English (Great Britain)</option>
											<option value="AU" <?php if ($payment_properties->paypal_language == 'AU')
{
    echo 'selected="selected"';
} ?>>English (Australian)</option>
											<option value="BG" <?php if ($payment_properties->paypal_language == 'BG')
{
    echo 'selected="selected"';
} ?>>Bulgarian</option>
											<option value="CN" <?php if ($payment_properties->paypal_language == 'CN')
{
    echo 'selected="selected"';
} ?>>Chinese</option>
											<option value="DK" <?php if ($payment_properties->paypal_language == 'DK')
{
    echo 'selected="selected"';
} ?>>Danish</option>
											<option value="NL" <?php if ($payment_properties->paypal_language == 'NL')
{
    echo 'selected="selected"';
} ?>>Dutch</option>
											<option value="EE" <?php if ($payment_properties->paypal_language == 'EE')
{
    echo 'selected="selected"';
} ?>>Estonian</option>
											<option value="FI" <?php if ($payment_properties->paypal_language == 'FI')
{
    echo 'selected="selected"';
} ?>>Finnish</option>
											<option value="FR" <?php if ($payment_properties->paypal_language == 'FR')
{
    echo 'selected="selected"';
} ?>>French</option>
											<option value="fr_CA" <?php if ($payment_properties->paypal_language == 'fr_CA')
{
    echo 'selected="selected"';
} ?>>French (Canada)</option>
											<option value="DE" <?php if ($payment_properties->paypal_language == 'DE')
{
    echo 'selected="selected"';
} ?>>German</option>
											<option value="GR" <?php if ($payment_properties->paypal_language == 'GR')
{
    echo 'selected="selected"';
} ?>>Greek</option>
											<option value="HU" <?php if ($payment_properties->paypal_language == 'HU')
{
    echo 'selected="selected"';
} ?>>Hungarian</option>
											<option value="IT" <?php if ($payment_properties->paypal_language == 'IT')
{
    echo 'selected="selected"';
} ?>>Italian</option>
											<option value="JP" <?php if ($payment_properties->paypal_language == 'JP')
{
    echo 'selected="selected"';
} ?>>Japanese</option>
											<option value="NO" <?php if ($payment_properties->paypal_language == 'NO')
{
    echo 'selected="selected"';
} ?>>Norwegian</option>
											<option value="PL" <?php if ($payment_properties->paypal_language == 'PL')
{
    echo 'selected="selected"';
} ?>>Polish</option>
											<option value="PT" <?php if ($payment_properties->paypal_language == 'PT')
{
    echo 'selected="selected"';
} ?>>Portuguese</option>
											<option value="RO" <?php if ($payment_properties->paypal_language == 'RO')
{
    echo 'selected="selected"';
} ?>>Romanian</option>
											<option value="ES" <?php if ($payment_properties->paypal_language == 'ES')
{
    echo 'selected="selected"';
} ?>>Spanish</option>
											<option value="SE" <?php if ($payment_properties->paypal_language == 'SE')
{
    echo 'selected="selected"';
} ?>>Swedish</option>
											<option value="CH" <?php if ($payment_properties->paypal_language == 'CH')
{
    echo 'selected="selected"';
} ?>>Swiss-German</option>
										</select>
										<input id="ps_paypal_enable_test_mode" <?php if (!empty($payment_properties->paypal_enable_test_mode))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px;margin-top: 15px">
									...
									<div id="ps_authorizenet_options" class="merchant_options" <?php if ($payment_properties->merchant_type != 'authorizenet')
{
    echo 'style="display: none"';
} ?>>
										<div id="ps_authorizenet_live_keys" <?php if (!empty($payment_properties->authorizenet_enable_test_mode))
{
    echo 'style="display: none;"';
} ?>>
										...
										<div id="ps_authorizenet_test_keys">
											<input id="ps_authorizenet_enable_test_mode" <?php if (!empty($payment_properties->authorizenet_enable_test_mode))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px;">
											...
											<div id="ps_authorizenet_test_keys_div" <?php if (empty($payment_properties->authorizenet_enable_test_mode))
{
    echo 'style="display: none;"';
} ?>>
									...
									<div id="ps_braintree_options" class="merchant_options" <?php if ($payment_properties->merchant_type != 'braintree')
{
    echo 'style="display: none"';
} ?>>
										<div id="ps_braintree_live_keys" <?php if (!empty($payment_properties->braintree_enable_test_mode))
{
    echo 'style="display: none;"';
} ?>>
										...
										<div id="ps_braintree_test_keys">
											<input id="ps_braintree_enable_test_mode" <?php if (!empty($payment_properties->braintree_enable_test_mode))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px;">
											...
											<div id="ps_braintree_test_keys_div" <?php if (empty($payment_properties->braintree_enable_test_mode))
{
    echo 'style="display: none;"';
} ?>>
									...
									<div id="ps_paypal_rest_options" class="merchant_options" <?php if ($payment_properties->merchant_type != 'paypal_rest')
{
    echo 'style="display: none"';
} ?>>
										<div id="ps_paypal_rest_live_keys" <?php if (!empty($payment_properties->paypal_rest_enable_test_mode))
{
    echo 'style="display: none;"';
} ?>>
										...
										<div id="ps_paypal_rest_test_keys">
											<input id="ps_paypal_rest_enable_test_mode" <?php if (!empty($payment_properties->paypal_rest_enable_test_mode))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px;">
											...
											<div id="ps_paypal_rest_test_keys_div" <?php if (empty($payment_properties->paypal_rest_enable_test_mode))
{
    echo 'style="display: none;"';
} ?>>
									...
									<div id="ps_stripe_options" class="merchant_options" <?php if ($payment_properties->merchant_type != 'stripe')
{
    echo 'style="display: none"';
} ?>>
										<div id="ps_stripe_live_keys" <?php if (!empty($payment_properties->stripe_enable_test_mode))
{
    echo 'style="display: none;"';
} ?>>
										...
										<div id="ps_stripe_test_keys">
											<input id="ps_stripe_enable_test_mode" <?php if (!empty($payment_properties->stripe_enable_test_mode))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px;">
											...
											<div id="ps_stripe_test_keys_div" <?php if (empty($payment_properties->stripe_enable_test_mode))
{
    echo 'style="display: none;"';
} ?>>
									...
									<div id="ps_stripe_info" class="merchant_options" <?php if ($payment_properties->merchant_type != 'stripe')
{
    echo 'style="display: none"';
} ?>>
									...
									<div id="ps_check_options" class="merchant_options" <?php if ($payment_properties->merchant_type != 'check')
{
    echo 'style="display: none"';
} ?>>
						...
						<li class="ps_arrow" <?php if ($payment_properties->enable_merchant === 0)
{
    echo 'style="display: none;"';
} ?>><span class="icon-arrow-down11 spacer-icon"></span></li>
						<li <?php if ($payment_properties->enable_merchant === 0)
{
    echo 'style="display: none;"';
} ?>>
							<div id="ps_box_payment_options" class="ps_box_main gradient_red">
								...
								<div class="ps_box_content">
									<div id="ps_currency_paypal_div" <?php if ($payment_properties->merchant_type != 'paypal_standard')
{
    echo 'style="display: none"';
} ?>>
										...
										<select class="select large" id="ps_currency_paypal" name="ps_currency_paypal" autocomplete="off">
											<option value="USD" <?php if ($payment_properties->currency == 'USD')
{
    echo 'selected="selected"';
} ?>>&#36; - U.S. Dollar</option>
											<option value="EUR" <?php if ($payment_properties->currency == 'EUR')
{
    echo 'selected="selected"';
} ?>>&#8364; - Euro</option>
											<option value="GBP" <?php if ($payment_properties->currency == 'GBP')
{
    echo 'selected="selected"';
} ?>>&#163; - Pound Sterling</option>
											<option value="AUD" <?php if ($payment_properties->currency == 'AUD')
{
    echo 'selected="selected"';
} ?>>A&#36; - Australian Dollar</option>
											<option value="CAD" <?php if ($payment_properties->currency == 'CAD')
{
    echo 'selected="selected"';
} ?>>C&#36; - Canadian Dollar</option>
											<option value="JPY" <?php if ($payment_properties->currency == 'JPY')
{
    echo 'selected="selected"';
} ?>>&#165; - Japanese Yen</option>
											<option value="THB" <?php if ($payment_properties->currency == 'THB')
{
    echo 'selected="selected"';
} ?>>&#3647; - Thai Baht</option>
											<option value="HUF" <?php if ($payment_properties->currency == 'HUF')
{
    echo 'selected="selected"';
} ?>>&#70;&#116; - Hungarian Forint</option>
											<option value="CHF" <?php if ($payment_properties->currency == 'CHF')
{
    echo 'selected="selected"';
} ?>>CHF - Swiss Francs</option>
											<option value="SGD" <?php if ($payment_properties->currency == 'SGD')
{
    echo 'selected="selected"';
} ?>>&#36; - Singapore Dollar</option>
											<option value="CZK" <?php if ($payment_properties->currency == 'CZK')
{
    echo 'selected="selected"';
} ?>>&#75;&#269; - Czech Koruna</option>
											<option value="SEK" <?php if ($payment_properties->currency == 'SEK')
{
    echo 'selected="selected"';
} ?>>kr - Swedish Krona</option>
											<option value="DKK" <?php if ($payment_properties->currency == 'DKK')
{
    echo 'selected="selected"';
} ?>>kr - Danish Krone</option>
											<option value="NOK" <?php if ($payment_properties->currency == 'NOK')
{
    echo 'selected="selected"';
} ?>>kr - Norwegian Krone</option>
											<option value="PHP" <?php if ($payment_properties->currency == 'PHP')
{
    echo 'selected="selected"';
} ?>>&#36; - Philippine Peso</option>
											<option value="MYR" <?php if ($payment_properties->currency == 'MYR')
{
    echo 'selected="selected"';
} ?>>RM - Malaysian Ringgit</option>
											<option value="NZD" <?php if ($payment_properties->currency == 'NZD')
{
    echo 'selected="selected"';
} ?>>NZ&#36; - New Zealand Dollar</option>
											<option value="PLN" <?php if ($payment_properties->currency == 'PLN')
{
    echo 'selected="selected"';
} ?>>&#122;&#322; - Polish Złoty</option>
											<option value="BRL" <?php if ($payment_properties->currency == 'BRL')
{
    echo 'selected="selected"';
} ?>>R&#36; - Brazilian Real</option>
											<option value="HKD" <?php if ($payment_properties->currency == 'HKD')
{
    echo 'selected="selected"';
} ?>>HK&#36; - Hong Kong Dollar</option>
											<option value="MXN" <?php if ($payment_properties->currency == 'MXN')
{
    echo 'selected="selected"';
} ?>>Mex&#36; - Mexican Peso</option>
											<option value="TWD" <?php if ($payment_properties->currency == 'TWD')
{
    echo 'selected="selected"';
} ?>>NT&#36; - Taiwan New Dollar</option>
											<option value="TRY" <?php if ($payment_properties->currency == 'TRY')
{
    echo 'selected="selected"';
} ?>>TL - Turkish Lira</option>
										</select>
									</div>
									<div id="ps_currency_stripe_div" <?php if ($payment_properties->merchant_type != 'stripe')
{
    echo 'style="display: none"';
} ?>>
											...
											<option value="PHP" <?php if ($payment_properties->currency == 'PHP')
{
    echo 'selected="selected"';
											...
											<option value="ZAR" <?php if ($payment_properties->currency == 'ZAR')
{
    echo 'selected="selected"';
} ?>>R - South African Rand</option>
											<option value="IDR" <?php if ($payment_properties->currency == 'IDR')
{
    echo 'selected="selected"';
} ?>>Rp - Indonesian Rupiah</option>
											<option value="MYR" <?php if ($payment_properties->currency == 'MYR')
{
    echo 'selected="selected"';
} ?>>RM - Malaysian Ringgit</option>
											...
											<option value="TRY" <?php if ($payment_properties->currency == 'TRY')
{
    echo 'selected="selected"';
									...
									<div id="ps_currency_authorizenet_div" <?php if ($payment_properties->merchant_type != 'authorizenet')
{
    echo 'style="display: none"';
} ?>>
											...
											<option value="NZD" <?php if ($payment_properties->currency == 'NZD')
{
    echo 'selected="selected"';
									...
									<div id="ps_currency_braintree_div" <?php if ($payment_properties->merchant_type != 'braintree')
{
    echo 'style="display: none"';
} ?>>
											...
											<option value="AUD" <?php if ($payment_properties->currency == 'AUD')
{
    echo 'selected="selected"';
									...
									<div id="ps_currency_paypal_rest_div" <?php if ($payment_properties->merchant_type != 'paypal_rest')
{
    echo 'style="display: none"';
} ?>>
											...
											<option value="TRY" <?php if ($payment_properties->currency == 'TRY')
{
    echo 'selected="selected"';
									...
									<div id="ps_currency_check_div" <?php if ($payment_properties->merchant_type != 'check')
{
    echo 'style="display: none"';
} ?>>
											...
											<option value="IDR" <?php if ($payment_properties->currency == 'IDR')
{
    echo 'selected="selected"';
											...
											<option value="INR" <?php if ($payment_properties->currency == 'INR')
{
    echo 'selected="selected"';
} ?>>Rs - Indian Rupee</option>
											<option value="MYR" <?php if ($payment_properties->currency == 'MYR')
{
    echo 'selected="selected"';
} ?>>RM - Malaysian Ringgit</option>
											...
											<option value="TRY" <?php if ($payment_properties->currency == 'TRY')
{
    echo 'selected="selected"';
									...
									<div id="ps_optional_settings">
										...
										<span id="ps_enable_fast_checkout" class="ps_options_span stripe_option" <?php if (in_array($payment_properties->merchant_type, array(
    'stripe'
)))
{
    echo 'style="display: block"';
} ?>>
											<input id="ps_enable_payment_request_button" <?php if (!empty($payment_properties->stripe_enable_payment_request_button))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px">
											...
											<div id="ps_enable_fast_checkout_div" <?php if (empty($payment_properties->stripe_enable_payment_request_button))
{
    echo 'style="display: none"';
} ?>>
												...
												<select class="select large" id="ps_stripe_account_country" name="ps_stripe_account_country" autocomplete="off">
													<option value="US" <?php if ($payment_properties->stripe_account_country == 'US')
{
    echo 'selected="selected"';
} ?>>United States</option>
													<option value="GB" <?php if ($payment_properties->stripe_account_country == 'GB')
{
    echo 'selected="selected"';
} ?>>United Kingdom</option>
													<option value="AU" <?php if ($payment_properties->stripe_account_country == 'AU')
{
    echo 'selected="selected"';
} ?>>Australia</option>
													<option value="AT" <?php if ($payment_properties->stripe_account_country == 'AT')
{
    echo 'selected="selected"';
} ?>>Austria</option>
													<option value="BE" <?php if ($payment_properties->stripe_account_country == 'BE')
{
    echo 'selected="selected"';
} ?>>Belgium</option>
													<option value="BR" <?php if ($payment_properties->stripe_account_country == 'BR')
{
    echo 'selected="selected"';
} ?>>Brazil</option>
													<option value="CA" <?php if ($payment_properties->stripe_account_country == 'CA')
{
    echo 'selected="selected"';
} ?>>Canada</option>
													<option value="DK" <?php if ($payment_properties->stripe_account_country == 'DK')
{
    echo 'selected="selected"';
} ?>>Denmark</option>
													<option value="FI" <?php if ($payment_properties->stripe_account_country == 'FI')
{
    echo 'selected="selected"';
} ?>>Finland</option>
													<option value="FR" <?php if ($payment_properties->stripe_account_country == 'FR')
{
    echo 'selected="selected"';
} ?>>France</option>
													<option value="DE" <?php if ($payment_properties->stripe_account_country == 'DE')
{
    echo 'selected="selected"';
} ?>>Germany</option>
													<option value="HK" <?php if ($payment_properties->stripe_account_country == 'HK')
{
    echo 'selected="selected"';
} ?>>Hong Kong</option>
													<option value="IE" <?php if ($payment_properties->stripe_account_country == 'IE')
{
    echo 'selected="selected"';
} ?>>Ireland</option>
													<option value="JP" <?php if ($payment_properties->stripe_account_country == 'JP')
{
    echo 'selected="selected"';
} ?>>Japan</option>
													<option value="LU" <?php if ($payment_properties->stripe_account_country == 'LU')
{
    echo 'selected="selected"';
} ?>>Luxembourg</option>
													<option value="MX" <?php if ($payment_properties->stripe_account_country == 'MX')
{
    echo 'selected="selected"';
} ?>>Mexico</option>
													<option value="NL" <?php if ($payment_properties->stripe_account_country == 'NL')
{
    echo 'selected="selected"';
} ?>>Netherlands</option>
													<option value="NZ" <?php if ($payment_properties->stripe_account_country == 'NZ')
{
    echo 'selected="selected"';
} ?>>New Zealand</option>
													<option value="NO" <?php if ($payment_properties->stripe_account_country == 'NO')
{
    echo 'selected="selected"';
} ?>>Norway</option>
													<option value="SG" <?php if ($payment_properties->stripe_account_country == 'SG')
{
    echo 'selected="selected"';
} ?>>Singapore</option>
													<option value="ES" <?php if ($payment_properties->stripe_account_country == 'ES')
{
    echo 'selected="selected"';
} ?>>Spain</option>
													<option value="SE" <?php if ($payment_properties->stripe_account_country == 'SE')
{
    echo 'selected="selected"';
} ?>>Sweden</option>
													<option value="CH" <?php if ($payment_properties->stripe_account_country == 'CH')
{
    echo 'selected="selected"';
} ?>>Switzerland</option>
													<option value="IT" <?php if ($payment_properties->stripe_account_country == 'IT')
{
    echo 'selected="selected"';
} ?>>Italy</option>
													<option value="PT" <?php if ($payment_properties->stripe_account_country == 'PT')
{
    echo 'selected="selected"';
} ?>>Portugal</option>
												</select>
												<span id="ps_enable_fast_checkout_info">Supporting Apple Pay requires <a class="blue_dotted" href="http://help.machform.com/m/using-machform/l/880090-verifying-your-domain-with-apple-pay" target="_blank">some additional steps</a>.</span>
											</div>
										</span>
										<input id="ps_show_total_amount" <?php if (!empty($payment_properties->show_total))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px">
										...
										<div id="ps_show_total_location_div" <?php if (empty($payment_properties->show_total))
{
    echo 'style="display: none"';
} ?>>
												Display at 
												<select class="select medium" id="ps_show_total_location" name="ps_show_total_location" autocomplete="off">
													<option <?php if ($payment_properties->total_location == 'top')
{
    echo 'selected="selected"';
} ?> id="ps_location_top" value="top">top</option>
													<option <?php if ($payment_properties->total_location == 'bottom')
{
    echo 'selected="selected"';
} ?> id="ps_location_bottom" value="bottom">bottom</option>
													<option <?php if ($payment_properties->total_location == 'top-bottom')
{
    echo 'selected="selected"';
} ?> id="ps_location_top_bottom" value="top-bottom">top and bottom</option>
												</select>
										</div>
										<div style="clear: both;margin-top: 10px"></div>
										<div class="paypal_option stripe_option authorizenet_option paypal_rest_option braintree_option check_option" <?php if (!in_array($payment_properties->merchant_type, array(
    'stripe',
    'paypal_standard',
    'authorizenet',
    'paypal_rest',
...
)))
{
    echo 'style="display: none"';
											...
											<input id="ps_enable_tax" <?php if (!empty($payment_properties->enable_tax))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px">
											...
											<div id="ps_tax_rate_div" <?php if (empty($payment_properties->enable_tax))
{
    echo 'style="display: none"';
} ?>>
													Tax Rate:  
										...
										<div style="clear: both;margin-top: 10px"></div>
										<div class="paypal_option paypal_rest_option stripe_option authorizenet_option" <?php if (!in_array($payment_properties->merchant_type, array(
    'stripe',
    'paypal_standard',
    'authorizenet',
    'paypal_rest'
)))
{
    echo 'style="display: none"';
											...
											<input id="ps_enable_recurring" <?php if (!empty($payment_properties->enable_recurring))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px;">
											...
											<div id="ps_recurring_div" <?php if (empty($payment_properties->enable_recurring))
{
    echo 'style="display: none"';
} ?>>
...
?>
												...
												<select id="ps_recurring_cycle_unit" class="select" <?php if (!in_array($payment_properties->merchant_type, array(
    'paypal_standard',
    'authorizenet',
    'paypal_rest'
)))
{
    echo 'style="display: none"';
													...
													<option value="day" <?php if ($payment_properties->recurring_unit == 'day')
{
    echo 'selected="selected"';
} ?>>Day(s)</option>
													<option value="week" <?php if ($payment_properties->recurring_unit == 'week')
{
    echo 'selected="selected"';
} ?>>Week(s)</option>
													<option value="month" <?php if ($payment_properties->recurring_unit == 'month')
{
    echo 'selected="selected"';
} ?>>Month(s)</option>
													<option value="year" <?php if ($payment_properties->recurring_unit == 'year')
{
    echo 'selected="selected"';
} ?>>Year(s)</option>
												</select>
												<select id="ps_recurring_cycle_unit_month_year" class="select" <?php if ($payment_properties->merchant_type != 'stripe')
{
    echo 'style="display: none"';
}; ?>>
													<option value="week" <?php if ($payment_properties->recurring_unit == 'week')
													...
													<option value="year" <?php if ($payment_properties->recurring_unit == 'year')
{
    echo 'selected="selected"';
										...
										<div style="clear: both;margin-top: 10px"></div>
										<div class="paypal_option paypal_rest_option stripe_option authorizenet_option" id="ps_trial_div_container" <?php if (empty($payment_properties->enable_recurring) || !in_array($payment_properties->merchant_type, array(
    'paypal_standard',
    'paypal_rest',
    'stripe',
    'authorizenet'
)))
{
    echo 'style="display: none"';
											...
											<input id="ps_enable_trial" <?php if (!empty($payment_properties->enable_trial))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px;">
											...
											<div id="ps_trial_div" <?php if (empty($payment_properties->enable_trial))
{
    echo 'style="display: none"';
} ?>>
...
?>
												...
												<select id="ps_trial_unit" class="select">
													<option value="day" <?php if ($payment_properties->trial_unit == 'day')
{
    echo 'selected="selected"';
} ?>>Day(s)</option>
													<option value="week" <?php if ($payment_properties->trial_unit == 'week')
{
    echo 'selected="selected"';
} ?>>Week(s)</option>
													<option value="month" <?php if ($payment_properties->trial_unit == 'month')
{
    echo 'selected="selected"';
} ?>>Month(s)</option>
													<option value="year" <?php if ($payment_properties->trial_unit == 'year')
{
    echo 'selected="selected"';
} ?>>Year(s)</option>
												</select>
										...
										<div style="clear: both;margin-top: 10px"></div>
										<div class="stripe_option paypal_rest_option" id="ps_setupfee_div_container" <?php if (empty($payment_properties->enable_recurring) || !in_array($payment_properties->merchant_type, array(
    'stripe',
    'paypal_rest'
)))
{
    echo 'style="display: none"';
											...
											<input id="ps_enable_setupfee" <?php if (!empty($payment_properties->enable_setupfee))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px;">
											...
											<div id="ps_setupfee_div" <?php if (empty($payment_properties->enable_setupfee))
{
    echo 'style="display: none"';
} ?>>
										...
										<div style="clear: both;margin-top: 10px"></div>
										<div class="paypal_option stripe_option authorizenet_option paypal_rest_option braintree_option" id="ps_discount_div_container" <?php if (!in_array($payment_properties->merchant_type, array(
    'stripe',
    'paypal_standard',
    'authorizenet',
    'paypal_rest',
...
)))
{
    echo 'style="display: none"';
											...
											<input id="ps_enable_discount" <?php if (!empty($payment_properties->enable_discount))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px;">
											...
											<div id="ps_discount_div" <?php if (empty($payment_properties->enable_discount))
{
    echo 'style="display: none"';
} ?>>
												<ul>
													<li>
														<select class="select medium" id="ps_discount_type" name="ps_discount_type" autocomplete="off">
															<option <?php if ($payment_properties->discount_type == 'percent_off')
{
    echo 'selected="selected"';
} ?> value="percent_off">Percent Off</option>
															<option <?php if ($payment_properties->discount_type == 'amount_off')
{
    echo 'selected="selected"';
} ?> value="amount_off">Amount Off</option>
														</select> &#8674; <span class="symbol" id="discount_type_currency_sign" style="display: <?php if ($payment_properties->discount_type == 'percent_off')
{
    echo 'none';
}
else
{
    echo 'inline';
														...
														<input id="ps_discount_amount" name="ps_discount_amount" class="element text" style="width: 40px"  value="<?php echo htmlspecialchars($payment_properties->discount_amount); ?>" type="text"> <span style="display: <?php if ($payment_properties->discount_type == 'percent_off')
{
    echo 'inline';
}
else
{
    echo 'none';
} ?>" id="discount_type_percentage_sign">&#37;</span>
													</li>
													<li>
...
?> 
										...
										<div style="clear: both;margin-top: 10px"></div>
										<div class="stripe_option" id="ps_stripe_receipt_div_container" <?php if (!in_array($payment_properties->merchant_type, array(
    'stripe'
)))
{
    echo 'style="display: none"';
} ?>>
											<input id="ps_stripe_enable_receipt" <?php if (!empty($payment_properties->stripe_enable_receipt))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px;">
											...
											<div id="ps_stripe_enable_receipt_div" <?php if (empty($payment_properties->stripe_enable_receipt))
{
    echo 'style="display: none"';
} ?>>
												<ul>
...
?>
										...
										<div class="authorizenet_option" id="ps_authorizenet_email_div_container" <?php if (!in_array($payment_properties->merchant_type, array(
    'authorizenet'
)))
{
    echo 'style="display: none"';
} ?>>
											<input id="ps_authorizenet_enable_email" <?php if (!empty($payment_properties->authorizenet_enable_email))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px;">
											...
											<div id="ps_authorizenet_enable_email_div" <?php if (empty($payment_properties->authorizenet_enable_email))
{
    echo 'style="display: none"';
} ?>>
												<ul>
...
?>
										...
										<span class="ps_options_span paypal_option stripe_option authorizenet_option paypal_rest_option braintree_option" <?php if (in_array($payment_properties->merchant_type, array(
    'paypal_standard',
    'stripe',
    'authorizenet',
    'paypal_rest',
...
)))
{
    echo 'style="display: block"';
											...
											<input id="ps_delay_notifications" <?php if (!empty($payment_properties->delay_notifications))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px">
										...
										<span id="ask_billing_span" class="ps_options_span stripe_option authorizenet_option paypal_rest_option braintree_option" 
											<?php
if (in_array($payment_properties->merchant_type, array(
    'authorizenet',
    'paypal_rest',
    'braintree',
    'stripe'
...
?>
										>
											<input id="ps_ask_billing" <?php if (!empty($payment_properties->ask_billing))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px">
...
?>
										>
											<input id="ps_ask_shipping" <?php if (!empty($payment_properties->ask_shipping))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px">
										...
										<span id="save_cc_data_span" class="ps_options_span authorizenet_option" <?php if (in_array($payment_properties->merchant_type, array(
    'authorizenet'
)))
{
    echo 'style="display: block"';
} ?>>
											<input id="ps_save_cc_data" <?php if (!empty($payment_properties->authorizenet_save_cc_data))
{
    echo 'checked="checked"';
} ?> class="checkbox" value="" type="checkbox" style="margin-left: 0px">
								...
								<div class="ps_box_content">
									<div id="ps_box_price_selector">
										<select id="ps_pricing_type" class="select">
												<option value="fixed" <?php if ($payment_properties->price_type == 'fixed')
{
    echo 'selected="selected"';
} ?>>Fixed Amount</option>
												<option value="variable" <?php if ($payment_properties->price_type == 'variable')
{
    echo 'selected="selected"';
									...
									<div id="ps_box_price_fields">
										<div id="ps_box_price_fixed_amount_div" <?php if ($payment_properties->price_type == 'variable')
{
    echo 'style="display: none;"';
} ?>>
											...
											<span id="ps_price_name_container" <?php if ($payment_properties->merchant_type == 'stripe' && !empty($payment_properties->stripe_enable_receipt))
{
    echo 'style="display: none;"';
										...
										<div id="ps_box_price_variable_amount_div" <?php if ($payment_properties->price_type == 'fixed')
{
    echo 'style="display: none;"';
} ?>>
...
?>
    ...
    if (!empty($current_price_settings))
    {
        foreach ($current_price_settings as $element_id => $data)
        {
            ...
            if ($price_field_array[$element_id]['element_type'] == 'money')
            { //if this is price field
                $liprice_markup = '<li id="liprice_' . $element_id . '">' . '<table width="100%" cellspacing="0">' . '<thead>' . '<tr><td>' . '<strong>' . $price_field_array[$element_id]['complete_title'] . '</strong>' . '<a href="#" id="deleteliprice_' . $element_id . '" class="delete_liprice"><span class="icon-cancel-circle"></span></a>' . '</td></tr>' . '</thead>' . '<tbody>' . '<tr><td class="ps_td_field_label">Amount will be entered by the client.</td></tr>' . '</tbody>' . '</table>' . '</li>';
            }
            else
            {
                $liprice_markup = '<li style="" id="liprice_' . $element_id . '">' . '<table width="100%" cellspacing="0">' . '<thead>' . '<tr><td colspan="2">' . '<strong>' . $price_field_array[$element_id]['complete_title'] . '</strong>' . '<a href="#" id="deleteliprice_' . $element_id . '" class="delete_liprice"><span class="icon-cancel-circle"></span></a>' . '</td></tr>' . '</thead>' . '<tbody>';
                foreach ($data as $option_id => $price)
                {
                    $liprice_markup .= '<tr>' . '<td class="ps_td_field_label">' . $price_field_options_lookup[$element_id][$option_id] . '</td>' . '<td class="ps_td_field_price">' . '<span class="ps_td_currency">' . $currency_symbol . '</span>' . '<input type="text" class="element text large" value="' . $price . '" id="price_' . $element_id . '_' . $option_id . '">' . '</td>' . '</tr>';
                }
...
<script src="js/tippy.index.all.min.js"></script>
