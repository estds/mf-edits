...
//set cookie, so that we could check if the user support cookie on other section of the forms
        ...
        if ($submit_result['status'] === true)
        {
            ...
            { //the page has skip logic enable and a custom destination page has been set
                ...
                else if ($target_page_id == 'payment')
                {
                    ...
                    $form_properties = mf_get_form_properties($dbh, $input_array['form_id'], array(
                    ...
                    if (in_array($form_properties['payment_merchant_type'], array(
                        'stripe',
                        'authorizenet',
                        'paypal_rest',
                        'braintree'
